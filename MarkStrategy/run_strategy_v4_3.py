...
# YrMthList = ["202401","202402A","202402B","202402C","202402D"]
YrMthList = ["202401","202402"]
res0 = []
res1 = []
res2 = []
for Mth in YrMthList:
    res0.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f120m10normed1440_m12n300l0.05_roll1_{Mth}.pkl"))
    res1.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f240m10normed2880_m12n300l0.05_roll1_{Mth}.pkl"))
    res2.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f480m10normed2880_m12n300l0.05_roll1_{Mth}.pkl"))
...
res2 = []
for Mth in YrMthList:
    res0.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f120m10normed1440_m12n300l0.05_roll2_{Mth}.pkl"))
    res1.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f240m10normed2880_m12n300l0.05_roll2_{Mth}.pkl"))
    res2.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f480m10normed2880_m12n300l0.05_roll2_{Mth}.pkl"))
...
# YrMthList = ["202310A","202310B","202310C","202310D","202311A","202311B","202311C","202311D","202312A","202312B","202312C","202312D","202401A","202401B","202401C","202401D"]
res0 = []
res1 = []
res2 = []
for Mth in YrMthList:
    res0.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f120m10normed1440_m10n300l0.01_rollw_{Mth}.pkl"))
    res1.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f240m10normed2880_m10n300l0.01_rollw_{Mth}.pkl"))
    res2.append(pd.read_pickle(f"/mnt2/alpha_data/bn_v6_factor/xgb_predict_future_FMV15MD_f480m10normed2880_m10n300l0.01_rollw_{Mth}.pkl"))
