...
twap_data_dict = ds.get_min_feature(feature_list =
                            ...
                            , where = "/mnt/alpha_data/features_AlphaHF" ,data_tag = "AlphaHF", start_date = start_date, end_date = end_date)
future_data_dict.update(twap_data_dict)

# YrMthList = ["202301","202302","202303"]
YrMthList = ["202304B"]
res0 = []
res1 = []
res2 = []
for Mth in YrMthList:
    res0.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f10m5normed2880_roll1_{Mth}.pkl"))
    res1.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f20m5normed2880_roll1_{Mth}.pkl"))
    res2.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f30m5normed2880_roll1_{Mth}.pkl"))
...
res2 = []
for Mth in YrMthList:
    res0.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f10m5normed2880_roll4_{Mth}.pkl"))
    res1.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f20m5normed2880_roll4_{Mth}.pkl"))
    res2.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f30m5normed2880_roll4_{Mth}.pkl"))
...
res2 = []
for Mth in YrMthList:
    res0.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f10m5normed2880_roll12_{Mth}.pkl"))
    res1.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f20m5normed2880_roll12_{Mth}.pkl"))
    res2.append(pd.read_pickle(f"/mnt/alpha_data/mark_ml_fac3/xgb_predict_future_FMV5HF_f30m5normed2880_roll12_{Mth}.pkl"))
