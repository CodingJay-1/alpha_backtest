...
class AlphaStrategy(FutureBaseStrategy):
    def __init__(self, StrategyConfigPath):
        ...
        # self.alpha1_name = str(self.Parser.get(section ="strategy" ,option="alpha1_name"))
        # self.alpha2_name = str(self.Parser.get(section ="strategy" ,option="alpha2_name"))
        # self.alpha3_name = str(self.Parser.get(section ="strategy" ,option="alpha3_name"))
